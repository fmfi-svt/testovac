...
from . import disableq, front, givetime, login, models, monitor, update, printing, results, serve
site_modules = [disableq, front, givetime, login, models, monitor, update, printing, results, serve]
