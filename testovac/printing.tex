...
\begin{Qlist}
@{ for sub in question.subs }@\item @[ sub.body ]@ @{ if sub.answer or sub.points }@ \hskip0.5cm @{ endif }@ @{ if sub.answer }@ \textbf{ @[ sub.answer ]@ } @{ endif }@ @{ if sub.points }@ \textbf{ @[ sub.points ]@ } @{ endif }@
@{ endfor }@
\end{Qlist}
}
@{ endfor }@
